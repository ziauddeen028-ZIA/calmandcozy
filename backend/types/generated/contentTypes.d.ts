...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    previewImageId: Schema.Attribute.Integer;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product categories with nested hierarchy';
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    avatar_letter: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1;
      }>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Production-ready ecommerce order management';
    displayName: 'Order';
    pluralName: 'orders';
    singularName: 'order';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customizationData: Schema.Attribute.JSON;
    ...
    orderItems: Schema.Attribute.Component<'ecommerce.order-item', true> &
      Schema.Attribute.Required;
    ...
    stockDeducted: Schema.Attribute.Boolean &
      Schema.Attribute.Private &
      Schema.Attribute.DefaultTo<false>;
    supabaseId: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    actualPrice: Schema.Attribute.Decimal & Schema.Attribute.Required;
    availableColors: Schema.Attribute.JSON;
    availableSizes: Schema.Attribute.JSON;
    bundleGroup: Schema.Attribute.String;
    bundleOfferEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    bundlePrice: Schema.Attribute.Decimal;
    bundleQty: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 2;
        },
    ...
    colorVariants: Schema.Attribute.Component<'ecommerce.color-variant', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customizable: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    customizationType: Schema.Attribute.Enumeration<['t-shirt', 'mug']>;
    description: Schema.Attribute.RichText;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    homepageFeatured: Schema.Attribute.Boolean;
    ...
    theme: Schema.Attribute.Enumeration<['anime', 'football', 'cricket']>;
